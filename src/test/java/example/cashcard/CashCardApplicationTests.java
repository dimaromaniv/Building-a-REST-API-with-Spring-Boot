...
class CashCardApplicationTests {
    ...
    void shouldNotAllowAccessToCashCardsTheyDoNotOwn() {
        ResponseEntity<String> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .getForEntity("/cashcards/9999", String.class); // kumar2's data
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
    ...
    void shouldUpdateAnExistingCashCard() {
        ...
        HttpEntity<CashCard> updatedCashCard = new HttpEntity<>(updated);
        ResponseEntity<Void> request = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .exchange("/cashcards/99", HttpMethod.PUT, updatedCashCard, Void.class);
    ...
    void shouldNotDeleteACashCardThatDoesNotExist(){
        ResponseEntity<Void> deleteRequest = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .exchange("/cashcards/9999",HttpMethod.DELETE,null,Void.class);
        assertThat(deleteRequest.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
